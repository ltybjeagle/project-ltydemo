package com.sunny.maven.facade.feign.config;

import com.sunny.maven.facade.feign.interceptor.FeignRequestInterceptor;
import feign.Logger;
 ...
 * @create: 2021-12-15 15:11
 */
@Configuration
@EnableFeignClients(basePackages = "com.sunny.maven.facade.feign.client")
