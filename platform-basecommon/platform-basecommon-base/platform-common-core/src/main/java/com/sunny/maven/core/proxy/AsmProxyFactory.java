...
/**
 * @author SUNNY
 * @description: AsmProxyFactory
 * @create: 2022-11-20 11:50
 */
public class AsmProxyFactory {
    ...
    public static byte[] generateClass(Class<?>[] interfaces, String proxyClassName) {
        ...
        cw.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC, proxyClassName, null,
                Type.getInternalName(AsmProxy.class), getInterfacesName(interfaces));
        // 创建<init>
        createInit(cw);
        // 创建static
