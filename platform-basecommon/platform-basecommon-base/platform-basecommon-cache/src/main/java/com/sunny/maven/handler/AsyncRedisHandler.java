package com.sunny.maven.handler;
 ...
 */
public class AsyncRedisHandler implements AsyncTaskExecutor, InitializingBean, DisposableBean {
     ...
     * @param executor 线程池
     */
    public AsyncRedisHandler(AsyncTaskExecutor executor) {
