package com.sunny.maven.microservice.authentication.jwt.config;

import com.sunny.maven.microservice.authentication.jwt.filter.JwtAuthenticationTokenFilter;
import com.sunny.maven.microservice.authentication.jwt.filter.JwtJsonUsernamePasswordAuthenticationFilter;
import com.sunny.maven.microservice.authentication.jwt.password.JwtPasswordEncoder;
...
@EnableWebSecurity
@ComponentScan(basePackages = {"com.sunny.maven.microservice"})
